...
public abstract class SystemUiHider {
	 ...
	 * device and the device allows hiding it. In cases where the navigation
	 * bar is present but cannot be hidden, show and hide will toggle low
	 * profile mode.
	 */
	 ...
	 * {@link SystemUiHiderBase} or {@link SystemUiHiderHoneycomb} depending
	 * on the device.
	 * 
	 * @param activity
	 ...
	 * @param anchorView
	 *                The view on which
	 *                {@link View#setSystemUiVisibility(int)} will be
	 *                called.
	 * @param flags
