...
public class SettingsActivity extends PreferenceActivity {
	...
	private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
		...
		public boolean onPreferenceChange(Preference preference,
			...
			if (preference instanceof ListPreference) {
				...
				// For ringtone preferences, look up the correct
				// display value
				...
				if (TextUtils.isEmpty(stringValue)) {
					...
					Ringtone ringtone = RingtoneManager
							.getRingtone(preference
									.getContext(),
									Uri.parse(stringValue));

					if (ringtone == null) {
						// Clear the summary if there
						// was a lookup error.
						preference.setSummary(null);
					} else {
						// Set the summary to reflect
						// the new ringtone display
						// name.
	 ...
	 * the preference's value is changed, its summary (line of text below
